...
import { FormCollapse as FormCollapseSchema } from './schema'
import { FormCollapse as FormCollapseLocales  } from './locale'
...
export const FormCollapseBehavior=createBehavior(
  {
    name: 'FormCollapse',
    extends: ['Field'],
