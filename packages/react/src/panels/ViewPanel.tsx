...
import { TreeNode, ITreeNode, WorkbenchTypes } from '@sulesky/next-core'
...
export const ViewPanel: React.FC<IViewPanelProps> = observer(
  ({ type, children, scrollable = true, dragTipsDirection }) => {
    ...
    if (workbench.type === 'DESIGNABLE')
      return (
        <Viewport dragTipsDirection={dragTipsDirection}>{render()}</Viewport>
      )
    return (
      <div
        style={{
