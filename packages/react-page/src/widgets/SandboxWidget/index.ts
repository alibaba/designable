...
export interface ISandboxWidgetProps {
...
export interface SandboxWidgetRender {
  (render: (scope?: any) => JSX.Element): void
}

const useSandbox = (props: React.PropsWithChildren<ISandboxWidgetProps>) => {
...
export const SandboxWidget: React.FC<ISandboxWidgetProps> & {
  render: SandboxWidgetRender
} = ((props: ISandboxWidgetProps) => {
...
SandboxWidget.render = (render: (scope?: any) => JSX.Element) => {
  if (isFn(render)) {
    ReactDOM.render(
