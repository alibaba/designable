...
exports.build = exports.getRollupBasePlugin = void 0;
...
var getRollupBasePlugin = function () { return [
...
exports.getRollupBasePlugin = getRollupBasePlugin;
var build = function (rollupConfig) { return __awaiter(void 0, void 0, void 0, function () {
    var output, input, bundle;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                output = rollupConfig.output, input = __rest(rollupConfig, ["output"]);
                return [4 /*yield*/, (0, rollup_1.rollup)(input)];
            case 1:
                bundle = _a.sent();
                return [2 /*return*/, bundle.write(output)];
        }
    });
}); };
exports.build = build;
